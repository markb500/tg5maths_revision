...
export function generate() {
  ...
  recentIds = QLimitRepeats(recentIds, 12);
  ...
  switch (sum) {
    case 1: // Direct proportion – engine / propeller
      ...
      } while (k - dp(k, 4, -1) !== 0 || k === 1);

      sumq = `The engine speed of an aircraft is directly proportional to the propeller speed.<br>
              a. If the engine rotates at ${thouSep(engspeed, "&nbsp;")}&nbsp;rpm and the propeller rotates at ${thouSep(propspeed, "&nbsp;")}&nbsp;rpm, find the constant of proportionality (k) for the reduction gearbox.<br>
              b. Using the constant of proportionality calculated above, find the propeller speed when the engine speed is ${thouSep(engspeed + engspeedadj, "&nbsp;")}&nbsp;rpm, rounding your answer to 2 decimal places.`;

      suma = `$$\\begin{aligned}a.\\ \\ engspeed&\\propto propspeed\\\\[5pt]
             engspeed&=k\\ propspeed\\\\[5pt]
             \\frac{engspeed}{propspeed}&=k\\\\[5pt]
             \\frac{${thouSep(engspeed, "\\ ")}}{${thouSep(propspeed, "\\ ")}}&=k\\\\[5pt]
             \\underline{\\mathbf{${k}}}&=k\\\\[5pt]
             b.\\ \\ \\frac{engspeed}{k}&=propspeed\\\\[5pt]
             \\frac{${thouSep(engspeed + engspeedadj, "\\ ")}}{${k}}&=propspeed\\\\[5pt]
             \\underline{\\mathbf{${thouSep(dp((engspeed + engspeedadj) / k, 2, 2), "\\ ")}}}&=propspeed\\ (2\\ dp)\\end{aligned}$$`;
      break;
        case 2:
            do {
                propspeed =  rndgen(2000, 3000, 0, 50, -1);
