// js/generators/stats.js — Probability (TG5 Maths pt I)
import { QLimitRepeats } from '../utils.js';

const NOTES = 'images/20240924-TG5MathsBook4-ProbabilityV1_0-APO.pdf#page=1';
...
export function generate() {
  ...
  recent = QLimitRepeats(recent, 4);
  const sum = recent[recent.length - 1];
